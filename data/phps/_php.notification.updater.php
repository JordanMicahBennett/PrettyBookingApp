<?php
	...
	//establish processes
		...
		$sql = "update notifications set IsMarkedRead ='read' where AdminEmail ='".$adminEmail."' and DayOfMonth = '".$dayOfMonth."' and Month = '".$month."' and DayOfWeek = '".$dayOfWeek."' and Hour = '".$hour."' and StudentEmail = '".$studentEmail."'";
